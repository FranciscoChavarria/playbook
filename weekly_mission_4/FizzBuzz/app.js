...
const assignBothFizzBuzzTrick = function(explorer){
...
const explorersInBoth = explorersInNode.map((explorer) => assignBothFizzBuzzTrick(explorer));
console.log(explorersInBoth);